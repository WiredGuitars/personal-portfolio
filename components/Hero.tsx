    ...
    >
      ...
      >
        ...
        <a
          href="/Resume.pdf"
          download={true}
          className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full  outline-none focus:scale-110 hover:scale-110  active:scale-105 transition shadow-md borderBlack dark:bg-white/10"
        >
          Download CV{" "}
        ...
        <a
          ...
          className="bg-white p-4 text-gray-700 flex items-center gap-2 rounded-full text-[1.15rem]  outline-none focus:scale-110 hover:scale-[1.15] active:scale-[1.05] transition shadow-md borderBlack dark:bg-white/10 dark:text-white/60"
        >
          <BsLinkedin />
        </a>
        <a
          href="https://github.com/WiredGuitars"
          className="bg-white p-4 text-gray-700 flex items-center gap-2 rounded-full text-[1.35rem]  outline-none focus:scale-110   hover:scale-[1.15] active:scale-[1.05] transition shadow-md borderBlack dark:bg-white/10 dark:text-white/60"
        >
          <FaGithubSquare />
        </a>
      </motion.div>
